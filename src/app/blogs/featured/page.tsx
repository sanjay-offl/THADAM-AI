...
export const metadata = { title: 'Featured Stories | THADAM AI' };
...
export default function FeaturedPage() {
  ...
  return (
    <div className="container" style={{ padding: 'var(--space-4xl) 0', minHeight: '80vh' }}>
      <h1 className="section-title text-gradient font-heading" style={{ fontSize: '3rem', marginBottom: 'var(--space-md)' }}>⭐ Featured Stories</h1>
      <p style={{ color: 'var(--muted)', fontSize: 'var(--text-lg)', marginBottom: 'var(--space-2xl)' }}>Hand-picked sustainability insights by our editors.</p>
